...
![Download Mastors-Gridder](https://img.shields.io/badge/Download-Mastors--Gridder-blue.svg)
...
To get started, visit this page to download: [Mastors-Gridder Releases](https://github.com/haidarjakiem/Mastors-Gridder/releases).
...
2. Inside the folder, create an `index.html` file and a `style.scss` file.
3. Link your `style.scss` file in the `<head>` section of your `index.html` using a `<link>` tag.

### Step 2: Import Mastors-Gridder

In your `style.scss`, import Mastors-Gridder using:

```scss
@import 'path/to/mastors-gridder/mastors-gridder.scss';
```
...
Open the `index.html` file in your web browser. You should see your responsive grid in action.
...
- [Mastors-Gridder Releases](https://github.com/haidarjakiem/Mastors-Gridder/releases)
- [Documentation](#) (link to detailed docs)
- [GitHub Repository](https://github.com/haidarjakiem/Mastors-Gridder)
